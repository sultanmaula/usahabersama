...
<div class="container-fluid">
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h4 class="text-themecolor">Tambah Role</h4>
        </div>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{route('store-role')}}" method="post">@csrf
                        <div class="form-body">
                            <div class="row p-t-20">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="control-label">Role Name</label>
                                        <input type="text" name="role_name" class="form-control form-control-danger" value="{{ old('role_name') }}" placeholder="" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                            ...
                                            @foreach ($sub_menus as $sub_menu)
                                                @if ($sub_menu->parent_menu_id == $menu_utama->menu_id)
                                                    @if ($i == 1) 
                                                        <td>
                                                            <div class="form-check">
                                                                <input class="form-check-input child_from_{{$j}} sub_menu" parentid="{{$j}}" name="menus[]" type="checkbox" value="{{$sub_menu->id}}" id="sub_menu_{{$k}}">
