        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{route('update-nasabah')}}" method="post" enctype="multipart/form-data">@csrf
                        ...
                        <div class="form-body">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="nama_nasabah" id="nama_nasabah" value="{{$data['nama']}}" class="form-control" placeholder="" required>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label">Alamat</label>
                                        <input type="text" name="alamat" id="alamat" value="{{$data['alamat']}}" class="form-control" placeholder="" required>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="no_hp" id="no_hp" value="{{$data['no_hp']}}" class="form-control" placeholder="" required>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label">NIK</label>
                                        <input type="text" name="nik" id="nik" value="{{$data['nik']}}" class="form-control" placeholder="" required>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <img src="{{ url('nasabah_image/'.$data['foto']) }}" style="width: 100px; height: 78px;">
                                    </div>
