...
<div class="container-fluid">
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h4 class="text-themecolor">Edit Password Sales</h4>
        </div>
        <div class="col-md-7 align-self-center text-right">
            <div class="d-flex justify-content-end align-items-center">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('list-sales') }}">Sales</a></li>
                    <li class="breadcrumb-item active">Edit Password Sales</li>
                </ol>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <form class="form-horizontal" role="form" method="POST" action="{{ route('password.update.sales', [$sales->id]) }}">
                    ...
                    <div class="form-group">
                        <div class="col-md-8 col-md-offset-4">
                            ...
                            <a href="{{route('list-sales')}}" class="btn btn-inverse">Cancel</a>
                        </div>
                    </div>
                </form>
                </div>
