                            ...
                            <div class="row p-t-20">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nama" id="nama" class="form-control" value="{{ $admin['nama'] }}" placeholder="" required>
                                    </div>
                                </div>
                                <!--/span-->
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="no_hp" id="nik" class="form-control form-control-danger" value="{{ $admin['no_hp'] }}" placeholder="" required>
                                    </div>
                                </div>
                                <!--/span-->
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="email" id="email" class="form-control form-control-danger" value="{{ $admin['email'] }}" placeholder="" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
