        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{route('top-product-store')}}" enctype="multipart/form-data" method="post">@csrf
                        <div class="form-body ">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input name="expired_top_product" id="expired_top_product" class="form-control datepicker" value="{{ old('expired_top_product') }}">
                                    </div>
                                </div>
                            </div>
                        </div>
