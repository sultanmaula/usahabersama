...
<div class="container-fluid">
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h4 class="text-themecolor">List Aktivitas Log</h4>
        </div>
        <div class="col-md-7 align-self-center text-right">
            <div class="d-flex justify-content-end align-items-center">
                ...
                <a href="{{ route('add-aktifitaslog')}}">
                    <button type="button" class="btn btn-info d-none d-lg-block m-l-15"><i
                        class="fa fa-plus-circle"></i> Tambah Aktivitas Log</button>
                    </a>
                </div>
            </div>
        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="vcenter">Hapus Aktivitas Log</h4>
    ...
    <script>
        $(function () {
            ...
            $.post('delete-aktifitaslog/' + id).then()
            ...
            $(".delete-button").click(function(){
                ...
                $("#delete-form").attr('action', '../delete-aktifitaslog/'+id);
                $('#delete-modal').modal();
            });
        ...
        $(document).ready(function() {
            ...
            var table=$('#config-table').DataTable({
                ...
                {data: 'nama_aktifitas', name: 'nama_aktifitas'},
                {data: 'kode_aktifitas', name: 'kode_aktifitas'},
