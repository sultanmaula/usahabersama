...
<div class="container-fluid">
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h4 class="text-themecolor">List Departement</h4>
        </div>
        <div class="col-md-7 align-self-center text-right">
            <div class="d-flex justify-content-end align-items-center">
                <ol class="breadcrumb">
                <a href="{{route('departement')}}"><li class="breadcrumb-item"><a href="{{ route('departement') }}">Master</a></li></a>
                    <li class="breadcrumb-item active">Departement</li>
                </ol>
            <a href="{{route('adddepartement')}}">
                <button type="button" class="btn btn-info d-none d-lg-block m-l-15"><i
                        class="fa fa-plus-circle"></i> Tambah Departement</button>
            </a>
            </div>
        </div>
    </div>
                            ...
                            <tbody>
                                @foreach ($data as $mp)
                                    <tr>
                                        ...
                                        <td>{{$mp->deskripsi}}</td>
                                        <td>
                                            @if($mp->nama_departement =='SUPERADMIN')
                                                <a style="display: none;" href="{{route('editdepartement', $mp->id)}}"><button class="btn btn-xs btn-primary " type="button"><span class="btn-label"><i class="fa fa-file"></i></span></button></a>
                                            ...
                                            @elseif($mp->nama_departement =='PRINCIPLE')
                                                <a style="display: none;" href="{{route('editdepartement', $mp->id)}}"><button class="btn btn-xs btn-primary " type="button"><span class="btn-label"><i class="fa fa-file"></i></span></button></a>
                                                <button style="display: none;" class="btn btn-xs btn-danger delete-button" deletevalue="{{$mp->id}}" type="button"><span class="btn-label"><i class="fa fa-trash"></i></span></button>  
                                            @else
...
<script>
    ...
    $(".delete-button").click(function(){
        ...
        $("#delete-form").attr('action', '../master/departement/delete/'+id);
        $('#delete-modal').modal();
    });
