...
<div class="container-fluid">
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h4 class="text-themecolor">List Tipe Cicilan</h4>
        </div>
        <div class="col-md-7 align-self-center text-right">
            <div class="d-flex justify-content-end align-items-center">
                <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{route('list-cicilan')}}">Master</a></li>
                    <li class="breadcrumb-item active">Tipe Cicilan</li>
                </ol>
            <a href="{{route('addcicilan')}}">
                <button type="button" class="btn btn-info d-none d-lg-block m-l-15"><i
                        class="fa fa-plus-circle"></i> Tambah Cicilan</button>
            </a>
            </div>
        </div>
    </div>
                            ...
                            <tbody>
                                @foreach ($data as $mp)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{route('editcicilan', $mp->id)}}"><button class="btn btn-xs btn-primary " type="button"><span class="btn-label"><i class="fa fa-file"></i></span></button></a>
        ...
        <form id="delete-form" action="" method="post">@csrf
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="vcenter">Hapus Tipe Cicilan</h4>
...
<script>
     $(".delete-button").click(function(){
        ...
        $("#delete-form").attr('action', '../master/delete-tipe-cicilan/'+id);
        $('#delete-modal').modal();
    });
