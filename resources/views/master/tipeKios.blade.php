...
<div class="container-fluid">
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h4 class="text-themecolor">List Tipe Kios</h4>
        </div>
        <div class="col-md-7 align-self-center text-right">
            <div class="d-flex justify-content-end align-items-center">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('tipe_kios') }}">Master</a></li>
                    <li class="breadcrumb-item active">Tipe Kios</li>
                </ol>
            <a href="{{route('addtipekios')}}">
                <button type="button" class="btn btn-info d-none d-lg-block m-l-15"><i
                        class="fa fa-plus-circle"></i> Tambah Tipe Kios</button>
            </a>
            </div>
        </div>
    </div>
                            ...
                            <tbody>
                                @foreach ($data as $mp)
                                    <tr>
                                        ...
                                        <td>{{$mp->nama_tipe_kios}}</td>
                                        <td>
                                            <a href="{{route('editTipeKios', $mp->id)}}"><button class="btn btn-xs btn-primary " type="button"><span class="btn-label"><i class="fa fa-file"></i></span></button></a>
...
<script>
    ...
    $(".delete-button").click(function(){
        ...
        $("#delete-form").attr('action', '../master/deletetipekios/'+id);
        $('#delete-modal').modal();
    });
