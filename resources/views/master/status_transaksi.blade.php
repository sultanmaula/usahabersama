...
<div class="container-fluid">
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h4 class="text-themecolor">List Status Transaksi</h4>
        </div>
        <div class="col-md-7 align-self-center text-right">
            <div class="d-flex justify-content-end align-items-center">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="javascript:void(0)">Master</a></li>
                    <li class="breadcrumb-item active">List Status Transaksi</li>
                </ol>
                <a href="{{ route('addstatus_transaksi')}}">
                    <button type="button" class="btn btn-info d-none d-lg-block m-l-15"><i
                            class="fa fa-plus-circle"></i> Tambah Status Transaksi</button>
                </a>
            </div>
        </div>
    </div>
        ...
        <form id="delete-form" action="" method="post">@csrf
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="vcenter">Hapus Status Transaksi</h4>
...
<script>
    $(function () {
        $(".delete-button").click(function(){
            ...
            $("#delete-form").attr('action', '../master/deletestatus_transaksi/'+id);
            $('#delete-modal').modal();
        });
