...
<div class="container-fluid">
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h4 class="text-themecolor">List Area</h4>
        </div>
        <div class="col-md-7 align-self-center text-right">
            <div class="d-flex justify-content-end align-items-center">
                ...
                <button type="button" onclick="location.href='{{ url('/master/area/add-area') }}'"class="btn btn-info d-none d-lg-block m-l-15"><i
                        class="fa fa-plus-circle"></i> Tambah Area</button>
            </div>
        </div>
    </div>
    <div class="row">
        ...
        <form id="delete-form" action="" method="post">@csrf
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="vcenter">Hapus Area</h4>
...
<script>
    ...
    $(document).on('click', '.delete-button', function(){
        ...
        $("#delete-form").attr('action', '../master/area/delete-area/'+id);
        $('#delete-modal').modal();
    });
