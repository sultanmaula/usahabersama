        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{route('store-aktifitaslog')}}" method="post">@csrf
                        <div class="form-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="control-label">Nama Aktivitas</label>
                                        <input type="text" name="nama_aktifitas" id="nama_aktifitas" class="form-control" placeholder="" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="control-label">Kode Aktivitas</label>
                                        <input type="text" name="kode_aktifitas" id="kode_aktifitas" class="form-control" placeholder="" required>
                                    </div>
                                </div>
                            </div>
                        </div>
