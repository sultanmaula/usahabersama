        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{route('update-category-news', $category['id'])}}" method="post" enctype="multipart/form-data" >@csrf
                        <div class="form-body">
                            <div class="row p-t-20">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="control-label">Nama Kategori</label>
                                        <input type="text" name="nama_kategori" id="nama" class="form-control" value="{{ $category['nama_kategori'] }}" placeholder="">
                                    </div>
                                </div>
                                <!--/span-->
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <output class="w-100" id="result_logo">
                                            <div>
                                                <img class="thumbnail_logo" src="{{ $category['image'] }}" title="preview image" style="width: 50%">
                                            </div>
                                        </output>
                                    </div>
                                </div>
