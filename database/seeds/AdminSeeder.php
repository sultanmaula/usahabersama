...
class AdminSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('menus')->insert([
            ...
            ['nama_menu' => 'Transaksi', 'parent_menu_id' => 0, 'created_at' => date('Y-m-d H:m:s'), 'updated_at' => date('Y-m-d H:m:s'), 'menu_id' => 2, 'slug' => 'transaksi', 'icon' => 'fas fa-money-bill-wave', 'no_urut' => 4],
            ...
            ['nama_menu' => 'List Transaksi', 'parent_menu_id' => 2, 'created_at' => date('Y-m-d H:m:s'), 'updated_at' => date('Y-m-d H:m:s'), 'menu_id' => 0, 'slug' => 'list-transaksi', 'icon' => 'null', 'no_urut' => 1],
            ['nama_menu' => 'Tambah Transaksi', 'parent_menu_id' => 2, 'created_at' => date('Y-m-d H:m:s'), 'updated_at' => date('Y-m-d H:m:s'), 'menu_id' => 0, 'slug' => 'add-transaksi', 'icon' => 'null', 'no_urut' => 2],
